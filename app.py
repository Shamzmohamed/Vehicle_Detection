...
import cv2
import os
from utils.vehicle_counter import process_video
...
if video_path:
    ...
    st.info("Please select a video source or upload a video file to start."
            "This project is to detect and count vehicles in videos. It uses computer vision techniques to detect vehicles, track them, and compute metrics such as vehicle count, average speed, and vehicle density.")
